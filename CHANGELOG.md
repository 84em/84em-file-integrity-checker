...
- When enabled, scans with 0 changes are not saved to the database
- Baseline scans are always saved regardless of this setting
- WP-CLI shows "Skipped" status when scans are not saved
